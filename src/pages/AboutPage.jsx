        ...
        <div className="about-info">
          ...
          <div className="about-text">
            ...
            <h1 className="about-title-76">
              {translation.subtitlePassionate}{' '}
              <span className="about-title">{translation.subtitleAbout} </span>
              {translation.subtitleCoding}
            </h1>
            <h1 className="about-title">
              <span className="about-title-76">
                {translation.subtitleMarkable}
              </span>{' '}
              {translation.subtitleProducts}
            </h1>
          </div>
        </div>
      </Reveal>
      ...
      <Reveal>
        <div className="about-images">
          <img
            ...
            alt="Fernanda in Japan"
          />
          <img
            className="img-2"
            src="../../../assets/about-photo-2.JPG"
            alt="Building in Kopenhagen"
          />
          <img
            className="img-3"
            src="../../../assets/about-photo-3.jpg"
            alt="Fernanda in a japanese garden"
          />
        </div>
      </Reveal>
